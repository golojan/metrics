    ...
    <>
      ...
      <div className="col-12 col-md-4 col-sm-12 col-lg-4 mb-2">
        <div className="stat-box">
          ...
          <Link href="#">
            <div className="text-blue-700 w-full">
              <FontAwesomeIcon icon={faPlus} /> New Lecturer (Male)
            </div>
          </Link>
          <Link href="#">
            <div className="text-blue-700 w-full">
              <FontAwesomeIcon icon={faPlus} /> New Lecturer (Female)
            </div>
          </Link>
          <Link href="#">
            <div className="text-blue-700 w-full">
          ...
          <Link href="#">
            <div className="text-blue-700 w-full">
              <FontAwesomeIcon icon={faPlus} /> New Professor (Male)
            </div>
          </Link>
          <Link href="#">
            <div className="text-blue-700 w-full">
              <FontAwesomeIcon icon={faPlus} /> New Professor (Female)
            </div>
          </Link>
          <Link href="#">
            <div className="text-blue-700 w-full">
